    ...
    >
      <div
        className={cn(
          ...
          'rounded-[var(--radius)] border border-slate-800',
          'hover:[--opacity:0.6] hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none overflow-hidden'
        )}
      ...
      >
        ...
        <div
          className={cn(
            ...
            'opacity-[var(--opacity)] transition-opacity transition-background duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-background',
        ...
        <div
          className={cn(
            'w-full h-full grid [grid-area:1/1] mix-blend-color-dodge opacity-[var(--opacity)] will-change-background transition-opacity',
            '[clip-path:inset(0_0_1px_0_round_var(--radius))]',
